    ...
    <div class="container-fluid row row-cols-1">
        ...
        <div class="m-4">
            ...
            <div class="col-12 row inputs flex-grow-3">
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <label class="form-label">Expected Regularization Date</label>
                    <input type="text" class="form-control datepicker" v-model="info.expected_regularization_date"
                        ref="flatpickrInput2" placeholder="Select a date" />
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <label class="form-label">Regularization Date</label>
                    <input type="text" class="form-control datepicker" v-model="info.regularization_date"
                        ref="flatpickrInput3" placeholder="Select a date" />
                </div>
                <div class="col-12 col-lg-4 mb-4">
